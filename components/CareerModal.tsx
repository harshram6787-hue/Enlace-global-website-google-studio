...
export function CareerModal({ isOpen, onClose }: CareerModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200 overflow-y-auto">
      <div className="bg-white rounded-3xl max-w-2xl w-full p-6 sm:p-8 my-8 shadow-2xl border border-emerald-100 relative overflow-hidden max-h-[90vh] flex flex-col">
          ...
          {isSubmitted ? (
            ...
            <div className="py-8 px-4 text-center space-y-6 animate-in fade-in zoom-in-95 duration-300">
              ...
              <div className="pt-2">
                <button
                  onClick={resetAndClose}
                  className="px-6 py-2.5 rounded-full text-sm font-bold text-white bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 shadow-md transition-all cursor-pointer"
                >
                  Close Window
                </button>
              </div>
            ...
            <div>
              <div className="mb-6 space-y-1">
                ...
                <h3 className="text-2xl font-extrabold text-slate-900 pt-1">Career Application</h3>
