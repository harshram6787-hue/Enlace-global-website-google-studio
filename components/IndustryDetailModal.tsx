...
export function IndustryDetailModal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-900/65 backdrop-blur-sm animate-in fade-in duration-200 overflow-hidden"
      onClick={(e) => {
    ...
    >
      <div
        className="bg-white rounded-3xl max-w-3xl w-full max-h-[calc(100vh-40px)] flex flex-col overflow-hidden shadow-2xl border border-emerald-100 relative"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div className="shrink-0 p-6 pb-4 sm:p-8 sm:pb-4 border-b border-slate-100 bg-white relative">
          ...
          <div className="flex items-center gap-3.5 pr-10">
            ...
            <div>
              ...
              <h3 id="modal-industry-title" className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-1">
                {industry.title}
              </h3>
            </div>
          </div>
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden p-6 sm:p-8 space-y-6 overscroll-contain">
          {/* Visual Banner */}
          <div className="relative h-48 sm:h-64 w-full rounded-2xl overflow-hidden bg-slate-100 border border-emerald-100 shadow-sm shrink-0">
            <img
              src={industry.image}
              alt={industry.title}
